...
public class Cell {
    ...
    /**
     * Returns the value of the `canBeSelected` field of this cell.
     * @return the value of the `canBeSelected` field of this cell
     */
    ...
    /**
     * Sets the `linkedNodes` field of this cell to the given `Link` object.
     * @param lnk the `Link` object to set the `linkedNodes` field to
     */
    ...
    /**
     * Returns the `parent` field of this cell.
     * @return the `parent` field of this cell
     */
    ...
    /**
     * Adds the given `LinkType` object to the set of links of this cell.
     * @param lt the `LinkType` object to add to the set of links of this cell
     */
    ...
    /**
     * Sets the `mainLink` field of this cell to the given `LinkType` object.
     * @param l the `LinkType` object to set the `mainLink` field to
     */
    ...
    /**
     * Returns the `mainLink` field of this cell.
     * @return the `mainLink` field of this cell
     */
